          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <h4> License Details <small class="text-danger"><?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> </small></h4>
                    <hr/>

                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="envato_purchase_code">Envato Purchase Code:*</label>
                            <input type="text" name="ENVATO_PURCHASE_CODE" required class="form-control" value="web4free.in" id="envato_purchase_code">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="ENVATO_USERNAME" required class="form-control" value="web4free.in" id="envato_username">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="email" name="ENVATO_EMAIL" class="form-control" id="envato_email" value="web4free.in@gmail.com" placeholder="optional">
